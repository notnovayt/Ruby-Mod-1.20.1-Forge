...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> HAZELNUT_PLACED_KEY = registerKey("hazelnut_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, HAZELNUT_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.HAZELNUT_KEY),
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(3, 0.1f, 2),
                        ModBlocks.HAZELNUT_SAPLING.get()));
    }


    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(RubyMod.MOD_ID, name));
    }
