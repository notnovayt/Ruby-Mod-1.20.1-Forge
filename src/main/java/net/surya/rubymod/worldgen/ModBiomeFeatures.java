package net.surya.rubymod.worldgen;
...
public class ModBiomeFeatures {
    ...
    public static final ResourceKey<BiomeModifier> ADD_TREE_HAZELNUT = registerKey("add_tree_hazelnut");
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(ADD_TREE_HAZELNUT, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(Tags.Biomes.IS_PLAINS),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.HAZELNUT_PLACED_KEY)),
                GenerationStep.Decoration.VEGETAL_DECORATION));
    }

    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(RubyMod.MOD_ID, name));
    }
}
