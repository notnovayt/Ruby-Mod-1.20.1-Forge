...
public class GemPolishingCategory implements IRecipeCategory<GemPolishingRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(RubyMod.MOD_ID, "gem_polishing");
    public static final ResourceLocation TEXTURE = new ResourceLocation(RubyMod.MOD_ID,
    ...
    public Component getTitle() {
        return Component.translatable("block.rubymod.gem_polishing_station");
    }
