...
public class ModBoatEntity extends Boat {
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case HAZELNUT -> ModItems.HAZELNUT_BOAT.get();
        };
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, Type.HAZELNUT.ordinal());
    }
    ...
    public static enum Type implements StringRepresentable {
        HAZELNUT(ModBlocks.HAZELNUT_PLANKS.get(), "hazelnut");
        ...
        public static ModBoatEntity.Type byName(String pName) {
            return CODEC.byName(pName, HAZELNUT);
        }
    }
}